public class Main {
    public static void main(String[] args) {
        ...
        for (int i =0;i<matrizea.length;i++){
            for (int e =0;e<matrizea.length;e++){
                ...
                matrizea[i][e]= proba2(posizioa,0);
                posizioa++;
            }
        }
    ...
    public static int proba1 (int i, int e){
    ...
    public static int proba2 (int i, int e){
    ...
    public static int proba3 (int i, int e){
    ...
    public static int proba4 (int i, int e){

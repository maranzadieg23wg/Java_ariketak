...
public class Zinema {
    ...
    public Zinema(String izena, int kopurua) throws PelikulaSalbuespena {

        try {

            if (izena == null || izena.equals("")){
                throw new PelikulaSalbuespena("Zinemak ezin du ez eduki izenik");
            }
        ...
        try {
            ...
            if (zenbakiaDa(String.valueOf(kopurua))){
                kopurua=Integer.parseInt(String.valueOf(kopurua));

            }else {
                throw new PelikulaSalbuespena("Zinemako areto kopurua zenbaki bat izan behar da, ez letra bat "+ kopurua);
            }
        }catch (PelikulaSalbuespena a){
            System.err.println("Errore bat gertatu da: "+a.getMessage());
        ...
        try {
            if (kopurua<=0){
                ...
                throw new PelikulaSalbuespena("Zinemako areto kopurua ezin da 0 baino gutxiago izan");
            }else {
        ...
        aretoa[0] = new Pelikula("???", 1900, 1);
    }

    int pelikularenAretoa(String izenburua, int urtea, int iraupena) throws PelikulaSalbuespena {
    ...
    public void gehituPelikula(Pelikula pelikula) throws PelikulaSalbuespena {
    ...
    public void gehituPelikula(Pelikula pelikula, int aretoNum) throws PelikulaSalbuespena {
    ...
    public void ezabatuPelikula(String izena) throws PelikulaSalbuespena {
    ...
    public void aldatuAretoa(Pelikula pelikula) throws PelikulaSalbuespena {
